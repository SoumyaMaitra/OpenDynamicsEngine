...
extern double frRatI;		//上体角補正用積分係数
extern double frRatA;		//上体角オフセット値
extern double fhRat;		//足上げ高さ補正値
extern double fwMax;		//歩幅最大値
